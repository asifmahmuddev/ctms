...
A freight platform. This is the foundation: project configuration, the account model the rest of the site authenticates against, and the public landing and about pages.
...
│   ├── js/script.js                 Scroll-to-top and flash messages
│   ├── lib/                         Bootstrap and Font Awesome
│   └── videos/hero.webm             Landing page hero video
├── templates/                       HTML templates
│   ├── includes/                    Navigation, footer and flash messages
│   ├── pages/                       Landing and about pages
